...
const Offer: React.FunctionComponent<Props> = (props: Props) => {
  ...
  const rentalOffer = props.rentalOffer;
  const ratingPercents = rentalOffer.rating * 20;
  const propertyBookmarkClasses = `property__bookmark-button button ${rentalOffer.is_favorite ? `property__bookmark-button--active` : null}`;
          ...
          <div className="property__container container">
            <div className="property__wrapper">
              ...
              <div className="property__name-wrapper">
                ...
                <button className={propertyBookmarkClasses} type="button">
